...
- [Historical source verification](historical-source-verification.md) が frozen manifest / source registry の登録 commit、exact blob、ancestor、path、newline portability、fail-closed 境界を定義する。
