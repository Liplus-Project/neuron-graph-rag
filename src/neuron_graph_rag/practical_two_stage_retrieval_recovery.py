...
PROTOCOL_ID = "github-retrieval-parity-v5-practical-two-stage-finalizer-recovery-v1"
SOURCE_PROTOCOL_ID = "github-retrieval-parity-v5-practical-two-stage-retrieval-v1"
ROOT = Path(__file__).resolve().parents[2]
MANIFEST = Path("tests/fixtures/practical_two_stage_retrieval_recovery_v1.manifest.json")
SCHEMA = Path("tests/fixtures/practical_two_stage_retrieval_recovery_v1.schema.json")
...
RECOVERY_EVIDENCE = Path("tests/evidence/practical_two_stage_retrieval_finalizer_recovery_v1")
