...
PROTOCOL_ID = "github-retrieval-parity-v5-v2-m3-chunk-shortlist-ablation-v1"
ROOT = Path(__file__).resolve().parents[2]
MANIFEST = Path("tests/fixtures/v2_m3_chunk_shortlist_ablation_v1.manifest.json")
SCHEMA = Path("tests/fixtures/v2_m3_chunk_shortlist_ablation_v1.schema.json")
MODELS = Path("tests/fixtures/v2_m3_chunk_shortlist_ablation_v1.models.json")
...
EVIDENCE = Path("tests/evidence/v2_m3_chunk_shortlist_ablation_v1")
