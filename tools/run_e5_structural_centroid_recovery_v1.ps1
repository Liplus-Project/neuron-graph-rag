...
$claimRelative = "tests/evidence/e5_structural_centroid_finalizer_recovery_v1/development.claim.json"
$resultRelative = "tests/evidence/e5_structural_centroid_finalizer_recovery_v1/development.recovered.json"
$goldRelative = "tests/fixtures/full_corpus_rerank_oracle_v2.gold.json"
$runnerRelative = "src/neuron_graph_rag/e5_structural_centroid_recovery.py"
$claimFiles = @(
    $runnerRelative,
    "tools/run_e5_structural_centroid_recovery_v1.ps1",
