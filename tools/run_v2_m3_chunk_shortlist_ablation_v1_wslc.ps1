...
$experimentRoot = Join-Path $workspace "workspace\experiments\v2_m3_chunk_shortlist_ablation_v1"
...
$volume = "github-v2-m3-chunk-shortlist-ablation-v1-runtime"
$containerRoot = "/opt/ngr-v2-m3-chunk-shortlist-v1"
...
$module = "neuron_graph_rag.v2_m3_chunk_shortlist_ablation"
...
if ($Action -eq "preflight") {
    ...
    $sourceMap = [ordered]@{
        ...
        "src\neuron_graph_rag\v2_m3_chunk_shortlist_ablation.py" = "src/neuron_graph_rag/v2_m3_chunk_shortlist_ablation.py"
        ...
        "tests\fixtures\v2_m3_chunk_shortlist_ablation_v1.manifest.json" = "tests/fixtures/v2_m3_chunk_shortlist_ablation_v1.manifest.json"
        "tests\fixtures\v2_m3_chunk_shortlist_ablation_v1.models.json" = "tests/fixtures/v2_m3_chunk_shortlist_ablation_v1.models.json"
        "tests\fixtures\v2_m3_chunk_shortlist_ablation_v1.schema.json" = "tests/fixtures/v2_m3_chunk_shortlist_ablation_v1.schema.json"
        "tools\run_v2_m3_chunk_shortlist_ablation_v1_wslc.ps1" = "tools/run_v2_m3_chunk_shortlist_ablation_v1_wslc.ps1"
    }
...
try {
    ...
    $evidenceRoot = Join-Path $root "tests\evidence\v2_m3_chunk_shortlist_ablation_v1"
    $exports = [ordered]@{
        "${containerRun}/preflight.attestation.json" = (Join-Path $evidenceRoot "development.preflight.json")
        "${containerSource}/tests/evidence/v2_m3_chunk_shortlist_ablation_v1/development.claim.json" = (Join-Path $evidenceRoot "development.claim.json")
        ...
        "${containerSource}/tests/evidence/v2_m3_chunk_shortlist_ablation_v1/development.observed.json" = (Join-Path $evidenceRoot "development.observed.json")
        "${containerSource}/tests/evidence/v2_m3_chunk_shortlist_ablation_v1/development.error.json" = (Join-Path $evidenceRoot "development.error.json")
    }
