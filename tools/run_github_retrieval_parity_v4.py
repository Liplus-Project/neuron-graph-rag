"""Audit or execute the frozen GitHub retrieval parity v4 protocol."""
...
from neuron_graph_rag.github_retrieval_parity_v4 import (
    audit_repository_lifecycle,
    audit_result_free,
    register_capture,
    register_preflight,
    run_registered_stage,
    verify_registered_preflight,
...
def main() -> None:
    ...
    if args.register_preflight:
        ...
        print(register_preflight(args.register_preflight, args.input, args.protocol_commit))
        return
    ...
    if args.verify_preflight:
        verify_registered_preflight(args.verify_preflight)
