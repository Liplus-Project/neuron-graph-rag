...
$claimRelative = "tests/evidence/practical_two_stage_retrieval_finalizer_recovery_v1/development.claim.json"
$resultRelative = "tests/evidence/practical_two_stage_retrieval_finalizer_recovery_v1/development.recovered.json"
$errorRelative = "tests/evidence/practical_two_stage_retrieval_finalizer_recovery_v1/development.error.json"
$goldRelative = "tests/fixtures/full_corpus_rerank_oracle_v2.gold.json"
$runnerRelative = "src/neuron_graph_rag/practical_two_stage_retrieval_recovery.py"
$claimFiles = @(
    $runnerRelative,
    "src/neuron_graph_rag/practical_two_stage_retrieval.py",
    "tools/run_practical_two_stage_retrieval_recovery_v1.ps1",
    ...
    "tests/fixtures/practical_two_stage_retrieval_recovery_v1.manifest.json",
    "tests/fixtures/practical_two_stage_retrieval_recovery_v1.schema.json"
)
